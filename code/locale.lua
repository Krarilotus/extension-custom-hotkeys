...
en['nativeGroupHint']='Original numbers select groups; press again to focus. Custom keys add alternatives.'
...
de['nativeGroupHint']='Originale Ziffern wählen Gruppen; erneut drücken zum Zentrieren. Eigene Tasten ergänzen sie.'
local M={}
