...
在 UCP 中启用模块后启动游戏即可生效，无需在启动器中打开其他开关或设置额外选项。在主菜单中打开快捷键设置，或在支持的菜单及正在进行的单人游戏中按 **F12**。如果已重新分配 F12，可按 **Ctrl+Shift+F12** 重新打开编辑器。点击操作行，或选中后按 **Enter**，再按下组合键。**Delete** 清除选中的绑定；应用更改即可保存。编辑器使用**游戏语言**，本说明使用启动器语言。
